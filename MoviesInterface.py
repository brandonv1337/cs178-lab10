...
def create_movie():
    ...
    if response.get("Items"):
        print(f"\nA movie titled '{title}' already exists.")
        return

    # Build the item — Title is required, Ratings starts as empty list
    item = {
        "Title":   title,
        "Ratings": []
    }
    ...
    print(f"\nMovie '{title}' successfully added to the table!\n")
    print_movie(item)
